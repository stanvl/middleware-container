...
import com.zju.middleware.MiddlewareManager;
...
public class StandardContext extends ContainerBase
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        if (getLoader() == null) {
            ...
            webappLoader.setLoaderClass("com.zju.middleware.MiddlewareWebappClassLoader");
        ...
        try {
            ...
            if (ok) {
                ...
                if (middlewareManager == null) {
                    ...
                    middlewareManager.setContext(this);
                }
                middlewareManager.start();
